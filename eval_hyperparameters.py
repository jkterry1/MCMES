...
net_arch = {
    ...
    "extra_large": [dict(pi=[1024, 512, 256], vf=[1024, 512, 256])],
}[params["net_arch"]]

params["policy_kwargs"] = dict(
    features_extractor_class=CustomCNN,
    features_extractor_kwargs=dict(num_frames=num_frames, activation_fn=activation_fn),
    net_arch=net_arch,
)
...
env = meltingpot_env.parallel_env(env_config=env_config)
...
eval_env = meltingpot_env.parallel_env(env_config=env_config)
