CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=1 nohup python3 eval_hyperparameters.py 12 &> ./eval_logs/eval_12.out &
sleep 3
...
sleep 3
CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=1 nohup python3 eval_hyperparameters.py 15 &> ./eval_logs/eval_15.out &